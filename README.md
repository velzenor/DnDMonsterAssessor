...
A somewhat common thing among GMs is to create custom monsters to exactly fit their story. In such cases, assessing an accurate CR for that monster can be challenging. The model created from this project can be used to resolve that issue.
